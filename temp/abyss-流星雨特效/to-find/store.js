    ...
    cards: [
      {
        id: 2,
        title: 'Boston',
        coverUrl: require('./assets/images/boston.png'),
        location: {
          lat: 'North Lat 36',
          lng: 'East Lng 97'
        },
        ...
        posts: [
          {
            id: 3,
            name: 'Amada Lin',
            faceUrl: require('./assets/images/face1.png'),
            date: new Date(),
            content:
          ...
          },
          {
            id: 4,
            name: 'Peter Allen',
            faceUrl: require('./assets/images/face2.png'),
            date: new Date(),
            content:
              'The federal beach atc requires states that receive funding to develop a risk-based beach evaluation and classification plan and apply it to'
          }
      ...
      },
      {
        id: 1,
        title: 'San Francisco',
        coverUrl: require('./assets/images/san_francisco.png'),
        location: {
          lat: 'North Lat 36',
          lng: 'East Lng 97'
        },
      ...
      },
      {
        id: 3,
        title: 'Washington',
        coverUrl: require('./assets/images/washington.png'),
        location: {
          lat: 'North Lat 36',
          lng: 'East Lng 97'
        },
      ...
      },
      {
        id: 4,
        title: 'New York',
        coverUrl: require('./assets/images/new_york.png'),
        location: {
          lat: 'North Lat 36',
          lng: 'East Lng 97'
        },
